...
function POST(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, prompt, response, error_1;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!prompt) { // Fixed logical issue with if condition
                        return [2 /*return*/, new server_1.NextResponse("prompt is required", { status: 400 })];
                    }
                    return [4 /*yield*/, replicate.run("riffusion/riffusion:8cf61ea6c56afd61d8f5b9ffd14d7c216c0a93844ce2d82ac1c9ecc9c7f24e05", {
                            input: {
                                prompt_a: prompt
                            }
                        })];
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("[MUSIC_ERROR]", error_1); // Use console.error for errors
